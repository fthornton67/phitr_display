...
void ServiceInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ServiceInfo *_t = static_cast<ServiceInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ServiceInfo::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ServiceInfo::serviceChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ServiceInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ServiceInfo.data,
      qt_meta_data_ServiceInfo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ServiceInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ServiceInfo.stringdata0))
        return static_cast<void*>(const_cast< ServiceInfo*>(this));
