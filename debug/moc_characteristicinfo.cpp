...
void CharacteristicInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CharacteristicInfo *_t = static_cast<CharacteristicInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CharacteristicInfo::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CharacteristicInfo::characteristicChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CharacteristicInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CharacteristicInfo.data,
      qt_meta_data_CharacteristicInfo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CharacteristicInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CharacteristicInfo.stringdata0))
        return static_cast<void*>(const_cast< CharacteristicInfo*>(this));
